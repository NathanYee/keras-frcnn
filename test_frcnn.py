...
for idx, img_name in enumerate(sorted(os.listdir(img_path))):
	...
	for key in bboxes:
		...
		for jk in range(new_boxes.shape[0]):
			...
			cv2.putText(img_scaled, textLabel, textOrg, cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 0, 0), 1)
	print('Elapsed time = {}'.format(time.time() - st))
	#cv2.imshow('img', img_scaled)
	#cv2.waitKey(0)
	cv2.imwrite('/home/nyee/datasets/simple/test_preds/{}.png'.format(idx),img_scaled)
	print(all_dets)
